...
const CommandMenu = () => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-start justify-center pt-[5vh] md:pt-[15vh] px-4 md:px-0">
      ...
      <div className="relative w-full max-w-[95%] md:max-w-2xl bg-surface border border-border rounded-2xl shadow-2xl overflow-hidden flex flex-col mx-auto max-h-[80vh]">
        ...
        <div className="overflow-y-auto p-2 flex-1">
          {filtered.length > 0 ? (
            ...
            <div className="p-8 text-center">
              <p className="text-text/40 font-mono text-sm">No tasks found</p>
            </div>
          )}
        </div>
